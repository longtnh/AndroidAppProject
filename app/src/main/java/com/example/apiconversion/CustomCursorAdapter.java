...
public class CustomCursorAdapter extends CursorAdapter {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        View v = layoutInflater.inflate(R.layout.row_note, viewGroup, false);
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        holder.ListTitle.setText(cursor.getString(cursor.getColumnIndex(DatabaseHelper.row_title)));
        holder.ListDetail.setText(cursor.getString(cursor.getColumnIndex(DatabaseHelper.row_note)));
        holder.ListCreated.setText(cursor.getString(cursor.getColumnIndex(DatabaseHelper.row_created)));
    }
